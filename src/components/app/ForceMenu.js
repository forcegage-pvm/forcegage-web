                ...
                <Route render={({ location, history }) => (
                    <React.Fragment>
                        <Menu className="Menu" secondary>
                            <img className="Menu-image" src={forceicon} alt="forcelogo"></img>
                            <h4 className="Menu-header">ForceGage</h4>
                            <Menu.Menu position='left'>
                                <Menu.Item name='athletes' active={activeItem === 'athletes'} onClick={this.handleItemClick} >
                        ...
                        <main>
                            ...
                            {/* <Route path="/other" component={props => <Playground />} /> */}
                        </main>
                    </React.Fragment>
                )}
                />
